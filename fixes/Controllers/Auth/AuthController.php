...
$userId = is_array($data['user']) ? $data['user']['id'] : $data['user']->id;
$userName = is_array($data['user']) ? $data['user']['username'] : $data['user']->username;
$data['token'] = JWT::encode(['id' => $userId, 'username' => $userName], DB_PASSWORD, "HS256");
